...
//
// PURPOSE: SEPERATE THE 7D-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF LEE WOO SING COLLEGE - THE GREEN
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF LEE WOO SING COLLEGE - THE GREEN

<template>
  <div id="gallery7d" class="container-fluid">
    ...
    <div>
      ...
      <h2>Lee Woo Sing College - The Green</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF LEE WOO SING COLLEGE - THE GREEN -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF LEE WOO SING COLLEGE - THE GREEN FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF LEE WOO SING COLLEGE - THE GREEN FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
