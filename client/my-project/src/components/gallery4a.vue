...
//
// PURPOSE: SEPERATE THE 4A-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF MORNINGSIDE COLLEGE DINING HALL
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF MORNINGSIDE COLLEGE DINING HALL

<template>
  <div id="gallery4a" class="container-fluid">
    ...
    <div>
      ...
      <h2>Morningside College Dining Hall</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF MORNINGSIDE COLLEGE DINING HALL -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF MORNINGSIDE COLLEGE DINING HALL FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF MORNINGSIDE COLLEGE DINING HALL FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
