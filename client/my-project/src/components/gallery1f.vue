...
//
// PURPOSE: SEPERATE THE 1F-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF LEE SHAU KEE BUILDING SNACK BAR
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF LEE SHAU KEE BUILDING SNACK BAR

<template>
  <div id="gallery1f" class="container-fluid">
    ...
    <div>
      ...
      <h2>Lee Shau Kee Building Snack Bar</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF LEE SHAU KEE BUILDING SNACK BAR -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF LEE SHAU KEE BUILDING SNACK BAR FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF LEE SHAU KEE BUILDING SNACK BAR FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
