...
//
// PURPOSE: SEPERATE THE 2B-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF CHUNG CHI COLLEGE STAFF CLUB
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF CHUNG CHI COLLEGE STAFF CLUB

<template>
  <div id="gallery2b" class="container-fluid">
    ...
    <div>
      ...
      <h2>Chung Chi College Staff Club</h2>
    </div>

    <!-- THIS IS VUE-PLUG-IN FOR DISPLAY THE PHOTO IN LIGHT-GALLERY -->S
    <light-gallery
      :images="imageList"
      :index="index"
      :disable-scroll="true"
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF CHUNG CHI COLLEGE STAFF CLUB -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF CHUNG CHI COLLEGE STAFF CLUB FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF CHUNG CHI COLLEGE STAFF CLUB FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
          'http://localhost:3000/api/gallery/' + 'Chung Chi College Staff Club'
        )
        .then(res => {
