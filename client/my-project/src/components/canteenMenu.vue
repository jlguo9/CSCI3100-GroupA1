...
export default {
  ...
  methods: {
    // METHOD: GETMENU
    // PURPOSE: GET THE CURRENT MENU FROM THE DATABASE
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET TODAY'S MENU AND STORE IT IN DATA 
    getMenu () {
      // ASK BACKEND TO GET TODAY'S MENU AND STORE IT IN DATA 
    ...
    // METHOD: DELETEITEM 
    // PURPOSE: DELETE AN ITEM IN THE MENU 
    // INPUT PARAMTER: (INDEX, ID)
    // ALGORITHM: 1. CHECK WHETHER THE USER DID NOT LOGIN, IF YES, SHOW ERROR AND REDIRECT TO LOGIN PAGE 
    //            2. ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND TO DELETE THE DISH BY SENDING DELETE COMMAND, IF NO, CANCEL DELETING
    //            3. BACKEND WILL DELETE SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
    deleteItem (index, id) {
      ...
      // ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND TO DELETE THE DISH BY SENDING DELETE COMMAND
    ...
    // METHOD: EDITITEM 
    // PURPOSE: EDIT AN ITEM IN THE MENU 
    // INPUT PARAMTER: (INDEX, ID)
    // ALGORITHM: 1. CHECK WHETHER THE USER DID NOT LOGIN, IF YES, SHOW ERROR AND REDIRECT TO LOGIN PAGE
    //            2. ASK USER TO EDIT BY SHOWING NEW WINDOW, IF YES, NEW CANTEENNAME/DISHNAME/DISHPRICE WILL RECORDED, CANCEL TO REMAIN.
    //            3. BY SENDING PUT COMMAND, BACKEND WILL EDIT SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
    editItem (index, id) {
      // IF USER DID NOT LOGIN, SHOW ERROR AND REDIRECT TO LOGIN PAGE
      if (
        this.myToken === '' ||
      ...
      // ASK USER TO EDIT BY SHOWING NEW WINDOW, IF YES, NEW CANTEENNAME/DISHNAME/DISHPRICE WILL RECORDED, CANCEL TO REMAIN.
      // BY SENDING PUT COMMAND, BACKEND WILL EDIT SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
      else {
    ...
    // METHOD: ADDTOCART 
    // PURPOSE: ADD AN ITEM IN THE MENU TO USER'S CART
    // INPUT PARAMTER: (INDEX, ID)
    // ALGORITHM: 1. CHECK WHETHER THE USER DID NOT LOGIN, IF YES, SHOW ERROR AND REDIRECT TO LOGIN PAGE
    //            2. ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND TO ADD THE DISH TO USER'S CART BY SENDING POST COMMAND, IF NO, CANCEL ADDING
    addToCart (index, id) {
      // IF USER DID NOT LOGIN, SHOW ERROR AND REDIRECT TO LOGIN PAGE
      if (
        this.myToken === '' ||
      ...
      // ASK USER TO CONFIRM ADDING TO CART, IF YES, ASK BACKEND TO ADD THE DISH TO USER'S CART
      else {
    ...
    // METHOD: CLEARMANU 
    // PURPOSE: CLEAR ALL ITEMS IN THE MENU 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. CHECK WHETHER THE USER DID NOT LOGIN, IF YES, SHOW ERROR AND REDIRECT TO LOGIN PAGE 
    //            2. CHECK WHETHER THE MENU IS EMPTY ALREADY, IF YES SHOW ERROR 
    //            2. IF NO, ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND TO DELETE THE DISH BY SENDING DELETE COMMAND, IF NO, CANCEL DELETING
    //            3. BACKEND WILL DELETE SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
    clearMenu () {
      ...
      // ELSE, ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND TO DELETE THE DISH BY SENDING DELETE COMMAND
      // BACKEND WILL DELETE SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
      else {
    ...
    // METHOD: ADDITEM 
    // PURPOSE: ADD AN NEW DISH
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. CHECK WHETHER THE USER DID NOT LOGIN, IF YES, SHOW ERROR AND REDIRECT TO LOGIN PAGE 
    //            2. CHECK WHETHER IF INFORMATION ENTERED IS NOT COMPLETED, IF NOT COMPLETED, SHOW ERROR
    //            3. IF COMPLETED, ASK BACKEND TO ADD THE DISH BY SENDING POST COMMAND
    addItem () {
      // IF USER DID NOT LOGIN, SHOW ERROR
      if (
        this.myToken === '' ||
      ...
      // ASK BACKEND TO ADD THE NEW DISH, THEN INVOCATE THE GET-MENU FUNCTION
      else {
        this.axios
          .post(
