...
export default {
  ...
  methods: {
    ...
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND AND GET TODAY'S MENU AND STORE IT IN DATA 
    getMenu () {
    ...
    // ALGORITHM: 1. CHECK WHETHER THE USER DID NOT LOGIN, IF YES, SHOW ERROR AND REDICT TO LOGIN PAGE 
    //            2. ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND AND DELETE THE DISH BY SENDING DELETE COMMAND, IF NO, CANCEL DELETING
    //            3. BACKEND WILL DELETE SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
    deleteItem (index, id) {
      // IF USER DID NOT LOGIN, SHOW ERROR AND REDICT TO LOGIN PAGE
      if (
        this.myToken === '' ||
        this.myToken === null ||
      ...
      // ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND AND DELETE THE DISH BY SENDING DELETE COMMAND
    ...
    // INPUT PARAMTER: (INDEX, ID)
    // ALGORITHM: 1. CHECK WHETHER THE USER DID NOT LOGIN, IF YES, SHOW ERROR AND REDICT TO LOGIN PAGE
    //            2. ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND AND ADD THE DISH TO USER'S CART BY SENDING POST COMMAND, IF NO, CANCEL ADDING
    addToCart (index, id) {
      // IF USER DID NOT LOGIN, SHOW ERROR AND REDICT TO LOGIN PAGE
      if (
        this.myToken === '' ||
    ...
    //            2. IF NO, ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND AND DELETE THE DISH BY SENDING DELETE COMMAND, IF NO, CANCEL DELETING
    //            3. BACKEND WILL DELETE SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
    clearMenu () {
      ...
      // ELSE, ASK USER TO CONFIRM DELETING, IF YES, ASK BACKEND AND DELETE THE DISH BY SENDING DELETE COMMAND
      // BACKEND WILL DELETE SUCCESSFULLY IF USER IS MANAGER, OTHERWISE UNSUCCESSFULLY, WITH ERROR
      else {
    ...
    //            2. IF COMPLETED, ASK BACKEND AND ADD THE DISH BY SENDING POST COMMAND
    addItem () {
      // IF USER DID NOT LOGIN, SHOW ERROR
      if (
        this.myToken === '' ||
