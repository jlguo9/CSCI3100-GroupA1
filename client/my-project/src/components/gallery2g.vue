...
//
// PURPOSE: SEPERATE THE 2G-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF POMMERENKE STUDENT CENTRE CAFÉ (PAPER&COFFEE)
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF POMMERENKE STUDENT CENTRE CAFÉ (PAPER&COFFEE)

<template>
  <div id="gallery2g" class="container-fluid">
    ...
    <div>
      ...
      <h2>Pommerenke Student Centre Café (Paper&Coffee)</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF POMMERENKE STUDENT CENTRE CAFÉ (PAPER&COFFEE) -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF POMMERENKE STUDENT CENTRE CAFÉ (PAPER&COFFEE) FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF POMMERENKE STUDENT CENTRE CAFÉ (PAPER&COFFEE) FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
