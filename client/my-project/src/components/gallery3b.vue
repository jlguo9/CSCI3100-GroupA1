...
//
// PURPOSE: SEPERATE THE 3B-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF CONNEXION, S.H. HO COLLEGE STAFF COMMON ROOM
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF CONNEXION, S.H. HO COLLEGE STAFF COMMON ROOM

<template>
  <div id="gallery3b" class="container-fluid">
    <!-- THIS IS GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE -->
    <div>
      <h1>
        Gallery:
        <router-link to="/gallery3"
          ><a class="btn btn-purple" style="color:white;float:right;"
            >Return to Last Page</a
          >
        </router-link>
      </h1>
      <h2>Connexion, S.H. Ho College Staff Common Room</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF CONNEXION, S.H. HO COLLEGE STAFF COMMON ROOM -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF CONNEXION, S.H. HO COLLEGE STAFF COMMON ROOM FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF CONNEXION, S.H. HO COLLEGE STAFF COMMON ROOM FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
