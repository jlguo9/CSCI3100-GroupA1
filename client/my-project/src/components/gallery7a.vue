...
//
// PURPOSE: SEPERATE THE 7A-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF >LEE WOO SING COLLEGE - WS PAVILION
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF >LEE WOO SING COLLEGE - WS PAVILION

<template>
  <div id="gallery7a" class="container-fluid">
    ...
    <div>
      ...
      <h2>Lee Woo Sing College - WS Pavilion</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF >LEE WOO SING COLLEGE - WS PAVILION -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF >LEE WOO SING COLLEGE - WS PAVILION FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF >LEE WOO SING COLLEGE - WS PAVILION FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
