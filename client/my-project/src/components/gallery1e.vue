...
//
// PURPOSE: SEPERATE THE 1E-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF BENJAMIN FRANKLIN CENTRE VEGETARIAN FOOD SHOP
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF BENJAMIN FRANKLIN CENTRE VEGETARIAN FOOD SHOP

<template>
  <div id="gallery1e" class="container-fluid">
    ...
    <div>
      ...
      <h2>Benjamin Franklin Centre Vegetarian Food Shop</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF BENJAMIN FRANKLIN CENTRE VEGETARIAN FOOD SHOP -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF BENJAMIN FRANKLIN CENTRE VEGETARIAN FOOD SHOP FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF BENJAMIN FRANKLIN CENTRE VEGETARIAN FOOD SHOP FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
