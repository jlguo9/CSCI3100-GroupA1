...
//
// PURPOSE: SEPERATE THE 2H-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF STAFF COMMON ROOM CLUBHOUSE
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF STAFF COMMON ROOM CLUBHOUSE

<template>
  <div id="gallery2h" class="container-fluid">
    ...
    <div>
      ...
      <h2>Staff Common Room Clubhouse</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF STAFF COMMON ROOM CLUBHOUSE -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF STAFF COMMON ROOM CLUBHOUSE FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF STAFF COMMON ROOM CLUBHOUSE FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
          'http://localhost:3000/api/gallery/' + 'Staff Common Room Clubhouse'
        )
        .then(res => {
