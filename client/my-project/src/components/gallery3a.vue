...
//
// PURPOSE: SEPERATE THE 3A-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF CANTEEN OF S.H. HO COLLEGE
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF CANTEEN OF S.H. HO COLLEGE

<template>
  <div id="gallery3a" class="container-fluid">
    ...
    <div>
      ...
      <h2>Canteen of S.H. Ho College</h2>
    </div>
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF CANTEEN OF S.H. HO COLLEGE -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF CANTEEN OF S.H. HO COLLEGE FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF CANTEEN OF S.H. HO COLLEGE FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
          'http://localhost:3000/api/gallery/' + 'Canteen of S.H. Ho College'
        )
        .then(res => {
