...
//
// PURPOSE: SEPERATE THE 6A-SUB-GALLERY PAGE FROM OTHER MODULES, MAKE IT MORE EASILY TO DISPLAY.
//          THIS MODULE IS USED FOR SHOWING ALL DISH PHOTOS OF NEW ASIA COLLEGE STAFF CANTEEN
//
// STRUCTURE: 
//   (H1,BUTTON, H2) GALLERY HEADER AND BUTTON FOR REDIRECTING TO LAST PAGE
//   (LIGHT-GALLERY) FOR DISPLAY THE PHOTO IN LIGHT-GALLERY
//   (UL) LIST OF DISH PHOTOS OF NEW ASIA COLLEGE STAFF CANTEEN
...
<template>
  <div id="gallery6a" class="container-fluid">
    ...
    <!-- THIS IS LIST OF DISH PHOTOS OF NEW ASIA COLLEGE STAFF CANTEEN -->
...
export default {
  ...
  methods: {
    // METHOD: GETIMAGE
    // PURPOSE: GET ALL DISH PHOTOS OF NEW ASIA COLLEGE STAFF CANTEEN FROM THE DATABASE  FROM THE DATABASE 
    // INPUT PARAMTER: NONE
    // ALGORITHM: 1. ASK BACKEND TO GET DISH PHOTOS OF NEW ASIA COLLEGE STAFF CANTEEN FROM THE DATABASE BY SENDING GET COMMAND, AND STORE IT IN DATA
    getImage () {
      this.axios
        .get(
